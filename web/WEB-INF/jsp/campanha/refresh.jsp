...
<c:choose>
            <c:when test="${not empty campanhaList}">
                <table>
                    ...
                    <tr>
                        <td width="11%"><fmt:formatDate pattern="dd/MM/yyyy" value="${c.data}" /></td>
                        <td>${c.nome}</td>
                        <td width="11%"><fmt:formatDate pattern="dd/MM/yyyy" value="${c.dataInicial}" /></td>
                        <td width="11%"><fmt:formatDate pattern="dd/MM/yyyy" value="${c.dataFinal}" /></td>
