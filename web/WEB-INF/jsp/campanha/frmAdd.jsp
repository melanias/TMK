        ...
        <form action="javascript:;" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="campanha.custoPrevisto" value="" id="custoPrevisto" size="16" maxlength="16" alt="valor" /></td>

                    <td><label for="custoReal">Custo Real (R$):</label></td>
                    <td><input type="text" name="campanha.custoReal" value="" id="custoReal" size="16" maxlength="16" alt="valor" /></td>
                </tr>
                <tr>
                    <td><label for="receitaEsperada">Receita Prevista (R$):</label></td>
                    <td><input type="text" name="campanha.receitaEsperada" value="" id="receitaEsperada" size="16" maxlength="16" alt="valor" /></td>

                    <td><label for="receitaReal">Receita Real (R$):</label></td>
                    <td><input type="text" name="campanha.receitaReal" value="" id="receitaReal" size="16" maxlength="16" alt="valor" /></td>
                </tr> 
                <tr>
