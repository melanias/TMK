        ...
        <form action="javascript:;" method="post">
            <table>
                <tr>
                    ...
                    <td><input type="text" name="doador.nascimento" id="dataNascimento" value="<fmt:formatDate value="${doador.nascimento}" type="date" pattern="dd/MM/yyyy"/>" size="16" maxlength="10" alt="data" /></td>
                </tr>
                <tr>
                    <td><label for="rg">RG:</label></td>
                    <td><input type="text" name="doador.rg" value="${doador.rg}" id="rg" size="16" maxlength="11" alt="rg" /></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="doador.telefone" value="${doador.telefone}" id="fone" size="16" maxlength="14" alt="phone" /></td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" name="doador.celular" value="${doador.celular}" id="celular" size="16" maxlength="14" alt="phone" /></td>
                </tr>
            </table>
            <hr />
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="doador.endereco.logradouro" value="${doador.endereco.logradouro}" id="logradouro" size="50" maxlength="200" readonly="readonly" /></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="doador.endereco.uf" value="${doador.endereco.uf}" id="uf" size="2" maxlength="2" readonly="readonly" /></td>
                </tr>
                <tr>
                    <td><label for="bairro">Bairro:</label></td>
                    <td><input type="text" name="doador.endereco.bairro" value="${doador.endereco.bairro}" id="bairro" size="50" maxlength="100" readonly="readonly" /></td>

                    <td><label for="cidade">Cidade:</label></td>
                    <td><input type="text" name="doador.endereco.cidade" value="${doador.endereco.cidade}" id="cidade" size="35" maxlength="100" readonly="readonly" /></td>
                </tr>
                <tr>
                    <td><input type="hidden" name="doador.id" value="${doador.id}" /></td>
                    <td><input type="button" value="Salvar" id="edit-doador" /></td>
                </tr>
            </table>
        </form>
    </c:when>
