        ...
        <form action="javascript:;" method="post">
            <table>
                <tr>
                    ...
                    <td><input type="text" name="newsletter.hostname" value="" id="hostname" size="14" maxlength="14" alt="hostname"/></td>
                </tr>
                <tr>
                    <td><label for="smtpport">Porta SMTP:</label></td>
                    <td><input type="text" name="newsletter.smtpport" value="" id="smtpport" size="3" maxlength="3" alt="smtport"/></td>
                </tr>
                <tr>
                    <td><label for="account">Conta:</label></td>
                    <td><input type="text" name="newsletter.account" value="" id="account" size="14" maxlength="100" alt="account"/></td>
                </tr>
                <tr>
                    <td><label for="smtpport">Senha:</label></td>
                    <td><input type="password" name="newsletter.password" value="" id="password" size="14" maxlength="32" alt="password"/></td>
                </tr>
                <tr>
                    <td></td>
